...
cd petsc-3.16.3
CC=icc CXX=icpc MPICC=mpiicc MPICXX=mpiicpc ./configure COPTFLAGS="-O3" CXXOPTFLAGS="-O3" FOPTFLAGS="-O3" --download-hypre --with-hdf5=0 --with-debugging=0 --prefix=../petsc-build
